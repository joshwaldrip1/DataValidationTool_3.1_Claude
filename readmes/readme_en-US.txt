...
* Microsoft Windows XP, Vista, 7, 8, 8.1, 10 or 11
...
If you perform an administrative installation using setup /a, you need to make sure that the file msvcr100.dll is installed on the system. This file is required for OpenOffice to start after an administrative installation. You can get the file from https://www.microsoft.com/en-US/download/details.aspx?id=26999
...
We hope you enjoy working with the new OpenOffice 4.1.15 and will join us online.
